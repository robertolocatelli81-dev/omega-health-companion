...
falsely claim to cover this JSON.
...
it proves the format, not an identity; its public half is pinned in the verifier and is never reported as registered,
whatever a local registry says.
